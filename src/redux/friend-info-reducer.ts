...
const initialState: InitialUserState = {
    id: 2,
    name: 'Dimach Aluyanov',
    age: 25,
    country: 'Belarus',
    city: 'Grodno',
    phone: '+375557772233',
    photos: {
        small: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
        large: null
    },
